...
class Spoiler:
	...
	def __init__(A,settings):
		...
		A.hint_list={}
	def toJson(A):
		'Convert spoiler to JSON.';d='Unknown Shop';c='skip';b='none';P='randomized';O=', ';A.settings.verify_hash();C=OrderedDict();B=OrderedDict();B['Seed']=A.settings.seed_id;B['No Logic']=A.settings.no_logic;B['Shuffle Enemies']=A.settings.enemy_rando;B['Move Randomization type']=A.settings.move_rando;B['Loading Zones Shuffled']=A.settings.shuffle_loading_zones;B['Decoupled Loading Zones']=A.settings.decoupled_loading_zones;Q=[]
		...
		B['Random Shop Prices']=A.settings.random_prices;B['Banana Port Randomization']=A.settings.bananaport_rando;B['Shuffle Shop Locations']=A.settings.shuffle_shops;B['Shuffle Kasplats']=A.settings.kasplat_rando_setting;B['K Rool Phases']=A.settings.krool_order;B['Key 8 Required']=A.settings.krool_access;B['Keys Required for K Rool']=A.GetKroolKeysRequired(A.settings.krool_keys_required);B['Fast Start']=A.settings.fast_start_beginning_of_game;B['Helm Setting']=A.settings.helm_setting;B['Quality of Life']=A.settings.quality_of_life;B['Tag Anywhere']=A.settings.enable_tag_anywhere;B['Fast GBs']=A.settings.fast_gbs;B['High Requirements']=A.settings.high_req;C['Settings']=B
