...
from ui.rando_options import disable_barrel_modal,disable_enemy_modal,disable_items_modal,disable_boss_rando,disable_colors,disable_music,disable_move_shuffles,disable_rw,hide_rgb,max_randomized_blocker,max_randomized_medals,max_randomized_troff,set_preset_options,toggle_b_locker_boxes,toggle_counts_boxes,toggle_medals_box,update_boss_required,disable_coupled_camera_shockwave
update_seed_text(_A)
set_preset_options()
