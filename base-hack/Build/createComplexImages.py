...
number_crop=[{_E:_G,_F:[{_A:0,_B:(0,0,20,24)},{_A:1,_B:(20,0,30,24)},{_A:2,_B:(30,0,45,24)},{_A:3,_B:(45,0,58,24)},{_A:4,_B:(58,0,76,24)}]},{_E:_H,_F:[{_A:5,_B:(0,0,14,24)},{_A:6,_B:(14,0,29,24)},{_A:7,_B:(29,0,43,24)},{_A:8,_B:(43,0,58,24)},{_A:9,_B:(58,0,76,24)}]}]
kongs=['dk','diddy','lanky','tiny','chunky']
hash_dir=getDir(_D)
if not os.path.exists(hash_dir):os.mkdir(hash_dir)
for file_info in number_crop:
	for num_info in file_info[_F]:
		key_num=num_info[_A]
...
rmve=[_G,_H,'boss_key.png','WXYL.png','specialchars.png','red_qmark_0.png','red_qmark_1.png']
for kong in kongs:
