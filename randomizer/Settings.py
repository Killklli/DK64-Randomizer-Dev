...
class Settings:
	...
	def resolve_settings(A):
		...
		if A.kong_rando:
			...
			if A.shuffle_loading_zones==I or A.shuffle_loading_zones==_D:A.kongs_for_progression=_C
