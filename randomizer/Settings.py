...
class Settings:
	...
	def resolve_settings(A):
		...
		if A.starting_kongs_count<5 and(A.shuffle_loading_zones==J or A.shuffle_loading_zones==_D):A.kongs_for_progression=_C
