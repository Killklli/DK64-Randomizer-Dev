...
def encrypt_settings_string(dict_data):
	...
	for I in ['download_patch_file','seed','settings_string','chunky_colors','chunky_custom_color','diddy_colors','diddy_custom_color','dk_colors','dk_custom_color','enguarde_colors','enguarde_custom_color','klaptrap_model','krusha_slot','misc_cosmetics','disco_chunky','lanky_colors','lanky_custom_color','rambi_colors','rambi_custom_color','random_colors','random_music','music_bgm','music_events','music_fanfares','tiny_colors','tiny_custom_color','override_cosmetics','remove_water_oscillation','colorblind_mode','search']:D.pop(I)
