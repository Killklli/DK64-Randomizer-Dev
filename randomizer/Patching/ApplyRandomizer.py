...
def patching_response(responded_data):
	...
	for (N,K) in f.items():
		h=[R,'algorithm','starting_kong','diddy_freeing_kong','tiny_freeing_kong','lanky_freeing_kong','chunky_freeing_kong','banana_medals_required','krool_phases','krool_keys_required','blocker_golden_bananas','troff_n_scoff_bananas']
