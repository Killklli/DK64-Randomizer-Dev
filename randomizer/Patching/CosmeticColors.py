...
def apply_cosmetic_colors(spoiler):
	...
	ROM().seek(A.settings.rom_data+310);ROM().writeMultipleBytes(N,1);V=[];m={};R={};t=[{E:'dk',K:[{F:W,D:3724,C:M}],H:X,L:Y,I:0},{E:'diddy',K:[{F:'cap_shirt',D:3686,C:M}],H:Z,L:a,I:1},{E:'lanky',K:[{F:p,D:3689,C:M},{F:q,D:3734,C:q}],H:b,L:c,I:2},{E:'tiny',K:[{F:p,D:6014,C:M}],H:d,L:e,I:3},{E:'chunky',K:[{F:'shirt_back',D:3769,C:r},{F:'shirt_front',D:3687,C:M}],H:f,L:g,I:4},{E:'rambi',K:[{F:W,D:3826,C:M}],H:h,L:i,I:5},{E:'enguarde',K:[{F:W,D:3847,C:M}],H:j,L:k,I:6}]
