...
def apply_cosmetic_colors(spoiler):
	'Apply cosmetic skins to kongs.';d='checkered';c='overalls';b='enguarde_colors';a='rambi_colors';Z='chunky_colors';Y='tiny_colors';X='lanky_colors';W='diddy_colors';V='dk_colors';T='02x';S='base';Q='colors';P='#000000';N='zones';K='block';J='kong_index';I='custom_setting';H='palettes';G='randomized';E='name';D='base_setting';C='kong';B='image';A='fill_type';R=[]
